...
docker run -e GO_ENV=development -p 7070:8080 mailcast:latest
```

## Docker Push Registry

```bash    
    docker build -t reg.com/mailcast/mailcast:latest --tag=mailcast:latest .
    docker push reg.com/mailcast/mailcast:latest
```
...
```
cd existing_repo
git remote add origin https://github.com/solpokus/mailcast
git branch -M main
